...
For raw Data content like JSON, XML, or binary data like images, pdf, zip files etc. you pass the data in the `tcKey` parameter, and set the `cContentType` property with the data's content type.

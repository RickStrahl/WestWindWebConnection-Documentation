...
> Most browsers don't preview JSON natively and you need to use an add-in to view JSON effectively. Consider adding the <a href="https://chromewebstore.google.com/detail/jsonview/gmegofmjomhknnokphhckolhcffdaihd?pli=1" target="top">JsonView addin for Chrome. Edge, Brave etc.</a> (shown in the screen shot) or <a href="https://addons.mozilla.org/en-us/firefox/addon/jsonview/" target="top">JsonView for FireFox</a>.
